 ...
 */
@ManagedBean(name = "facturaciofacordenMBean")
@ViewScoped
public class PFacturacionFacOrdenMBean extends ClientUtils implements Serializable {
     FacesContext facesContext = FacesContext.getCurrentInstance();
     CclienteFacOrdenfiMBean bean = (CclienteFacOrdenfiMBean) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "clientefacordenMBean");
    ...
    private String facturarordenentrega = "6";
    ...
    public PFacturacionFacOrdenMBean() {
...
//        }
    ...
    public String getFacturarordenentrega() {
        return facturarordenentrega;
    }

    public void setFacturarordenentrega(String facturarordenentrega) {
        this.facturarordenentrega = facturarordenentrega;
    }
