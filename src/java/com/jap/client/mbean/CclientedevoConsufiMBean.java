 ...
 */
@ManagedBean(name = "clientedevoconsufiMBean")
@ViewScoped
public class CclientedevoConsufiMBean extends ClientUtils implements Serializable {
    ...
    public CclientedevoConsufiMBean() {
