 ...
 */
@ManagedBean(name = "facturacionodtMBean")
@ViewScoped
public class PFacturacionOdtMBean extends ClientUtils implements Serializable {

    
    FacesContext facesContext = FacesContext.getCurrentInstance();
    CclienteOdtMBean bean = (CclienteOdtMBean) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "clienteodtMBean");
    ...
    private String ordendetaller="7";
...
//        }
    ...
    public String getOrdendetaller() {
        return ordendetaller;
    }

    public void setOrdendetaller(String ordendetaller) {
        this.ordendetaller = ordendetaller;
    }
