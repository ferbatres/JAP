 ...
 */
@ManagedBean(name = "facturacionnotaMBean")
@ViewScoped
public class PFacturacionNotaMBean extends ClientUtils implements Serializable {

    
    FacesContext facesContext = FacesContext.getCurrentInstance();
    CclienteNotaMBean bean = (CclienteNotaMBean) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "clienteNotaMBean");
    ...
    private  String notadecredito = "5";
